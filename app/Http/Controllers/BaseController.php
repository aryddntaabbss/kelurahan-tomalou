...
class BaseController extends Controller
{
    ...
    public function home()
    {
        return view ('/pages/home',[
            ...
            'title'=>'Website Resmi Kelurahan Seli'
        ]);
    }
    ...
    public function visimisi()
    {
        return view('pages.profil.visimisi',[
            'data'=>Visimisi::get(),
            'title'=> 'Visi dan Misi - Website Resmi Kelurahan Seli'
        ]);
    }
    ...
    public function sejarah()
    {
        return view('pages.profil.sejarah',[
            'data'=>Sejarah::get(),
            'title'=>'Sejarah Kelurahan Seli - Website Resmi Kelurahan Seli'
        ]);
    }
    public function gambaranumum()
    {
        return view('pages.profil.gambaranumum',[
            ...
            'title'=>'Gambaran Umum kelurahan Seli - Website Resmi Kelurahan Seli'
        ]);
    }
    ...
    public function perangkat()
    {
        return view('pages.profil.perangkat',[
            ...
            'title'=>'Perangkat Kelurahan Seli - Website Resmi Kelurahan Seli'
        ]);
    }
    ...
    public function lpm()
    {
        return view('pages.kelembagaan.lpm',[
            "lpm"=>Lpm::get(),
            'title'=>'Lembaga Pemberdayaan Masyarakat - Website Resmi Kelurahan Seli'
        ]);
    }
    ...
    public function pkk()
    {
        return view('pages.kelembagaan.pkk',[
            "pkk"=>Pkk::get(),
            'title'=>'Pemberdayaan Kesejahteraan Keluarga - Website Resmi Kelurahan Seli'
        ]);
    }
    ...
    public function informasi()
    {
        return view('pages.informasi.informasi',[
            ...
            'title'=> 'Informasi Seputar Kelurahan Seli - Website Resmi Kelurahan Seli'
        ]);
    }
    public function detail_informasi(Posts $posts)
    {
        return view('pages.informasi.detailInformasi',[
            'title'=> $posts->judul.'- Website Resmi Kelurahan Seli',
            'posts'=>$posts
        ]);
    }
