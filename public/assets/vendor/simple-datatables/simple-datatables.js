                            ...
                            const et = {
                                ...
                                template: ( t, e ) =>
                                    `<div class='${ t.classes.top }'>\n    ${ t.paging && t.perPageSelect
                                        ...
                                        : ""
                                    }\n    <nav class='${ t.classes.pagination
                                    }'></nav>\n</div>`,
                                classes: {
                                ...
                                editCellModal ()
                                {
                                    const t = this.data.cell,
                                        ...
                                        o = [
                                            ...
                                            `<label class='${ this.options.classes.label
                                            }'>${ a( i ) }</label>`,
                                        ...
                                        )
                                        {
                                            ...
                                            r.insertBefore(
                                                s( "div", {
                                                    ...
                                                    html: [
                                                        `<div class='${ this.options.classes.row }'>`,
                                                        `<label class='${ this.options.classes
                                                            .label
                                                        }'>${ a( i ) }</label>`,
                                                        `<input class='${ this.options.classes
                                                            .input
                                                        }' value='${ a(
                                                            n( t )
                                                        ) }' type='text'>`,
